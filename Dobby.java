...
public class Dobby {
    ...
    public static void main(String[] args) throws IOException, InterruptedException{
        ...
        //registering Java 8 WatchService (to wait for our turn)
        /*
        Path path = Paths.get(".");
 ...
 */
    ...
    public static int minimaxUtil(int board, int bestScore) {
        ...
        for(int i = 0; i <= emptySquares.size(); i++){ 
            ...
            int score = minimax(globalBoardCopy, globalWinnersCopy, board, depth, false, Integer.MIN_VALUE, Integer.MAX_VALUE);
            globalBoardCopy[board].squares[emptySquares.get(i)] = ' ';
    ...
    public static int minimax(Board[] globalBoardCopy, Board globalWinnersCopy, int board, int localDepth,
     boolean isMaximizing, int alpha, int beta) {
        int chosenMove = 0;
        //TODO pass a copy of global board 
        //  global board is only meant to capture the actual PLAYED moves
        /* TODO pass also the local board to play in
         * pass also the winners (global winner)
         */
        ...
        if(localDepth == Dobby.depth){    // TODO consider winning positions, DEPTH, and other terminal cases
            ...
            // return values[]
            //TODO stop when max depth reached
        }
